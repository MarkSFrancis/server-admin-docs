...
On Linux, I use a [CIFS](https://www.wikiwand.com/en/Server_Message_Block#CIFS) share to allow any Linux distro to connect.
...
//192.168.0.2/tank /mnt/tank cifs credentials=/etc/cifs-credentials,file_mode=0777,dir_mode=0777
```

</TabItem>
<TabItem value="/etc/cifs-credentials">
...
For Windows, I use a [SMB](https://www.wikiwand.com/en/Server_Message_Block) share. These can be connected to via the GUI on Windows.
